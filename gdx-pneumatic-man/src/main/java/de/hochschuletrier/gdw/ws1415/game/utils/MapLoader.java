...
public class MapLoader {
            ...
            for (Layer l : tiledMap.getLayers()) {
                ...
                if (l.getType() == Layer.Type.OBJECT) {
                    ...
                    if (olist == null) {
                        ...
                        for (LayerObject o : olist) {
                            // Einbinden der Objecte in die PoolEngine findet
                            // hier statt
                            ...
                            switch (o.getName()) {
                            case "Rock": {
                                // fügt der rockTirggerList einen neuen
                                // spawnable Rock an
                            ...
                            case "RockTriggerX": {
                                 ...
                                 * // Triggerd den Rock
                                 * 
                                 * // kreeire EventBox ent =
                                 * EntityCreator.createAndAddEventBox(
                                 * EventBoxType.EVENT , o.getX(), o.getY(),
                                 * engine ); ent.getComponent(
                                 * PositionComponent.class ).x = o.getX();
                                 * ent.getComponent( PositionComponent.class ).y
                                 * = o.getY();
                                 * 
                                 * 
                                 * // TODO trigger erhalten int triggID =
                                 * Integer.parseInt( o.getProperty( "Id","0" )
                                 * );
                                 * 
                                 * // erhalte Rocksafeattribute RockSafe
                                 * rockSafe; for ( RockSafe rs : rockTriggerList
                                 * ) { if ( rs.ID == triggID ) { rockSafe = rs;
                                 * break; } }
                                 * 
                                 * 
                                 * EntityCreator.createTrigger(engine, phySys,
                                 * (float
                                 * )o.getX(),(float)o.getY(),(float)o.getWidth
                                 * (),(float)o.getHeight(), (Entity ente) -> {
                                 * 
                                 * EntityCreator.createAndAddEventBox(
                                 * EventBoxType.EVENT , rockSafe.x, rockSafe.y,
                                 * engine );
                                 * 
                                 * } );
                                 */
                                ...
                                break;
                            default:
                                // TODO Exception wenn ein unbekanntes Objekt
                                // auftritt
                                break;
                            }
...

                {
                    ...
                    if (tiles != null) {
                                ...
                                for (int j = 0; j < tiles[i].length; j++) {
                                    ...
                                    if (tiles[i][j] != null) {
                                        ...
                                        case "Lava": {
                                            ...
                                            ent.add(c);
                                            // TODO welche Komponents beinhaltet
                                            // es
                                        }
                                            break;
                                        case "SpikeDown": {
                        ...
                        // sollte als Layertype : TILES angeben sein aber keine
                        // Tiles vorhanden
     ...
     * 
     * @param layer
     *            Layer in dem sich der Blcok befindet
     * @param x
     *            X-Position des Blocks
     * @param y
     *            Y-Position des Blocks
     ...
     * 
     * @param layer
     *            layer für die die Objekte gezogen werden sollen
     ...
     * 
     * /** gibt das Entity mit dem Index <index> zurueck !!! Momentan stehen
     * hier nur unvollständige Entities drinne !!!
     * 
     ...
     */
    /*
     * public Entity getEntity( int index) { return entities.get( index ); }
     * 
    ...
    /*
     * public static void main( String args[]) { MapLoader ml = new
     * MapLoader("data/maps/Test_Physics.tmx");
     * 
     * }
     */
