...
<tileset name="DummyTileset2" tilewidth="64" tileheight="64" spacing="64" margin="64">
 ...
 <tile id="1">
  <properties>
   <property name="Hitpoint" value="6"/>
   <property name="Invulnerable" value="false"/>
   <property name="Name" value="Block6"/>
   <property name="Type" value="Floor"/>
  </properties>
 </tile>
 <tile id="2">
  <properties>
   <property name="Hitpoint" value="5"/>
   <property name="Invulnerable" value="false"/>
   <property name="Name" value="Block5"/>
   <property name="Type" value="Floor"/>
  </properties>
 </tile>
 <tile id="3">
  <properties>
   <property name="Hitpoint" value="4"/>
   <property name="Invulnerable" value="false"/>
   <property name="Name" value="Block4"/>
   <property name="Type" value="Floor"/>
  </properties>
 </tile>
 <tile id="4">
  <properties>
   <property name="Hitpoint" value="3"/>
   <property name="Invulnerable" value="false"/>
   <property name="Name" value="Block3"/>
   <property name="Type" value="Floor"/>
  </properties>
 </tile>
 <tile id="5">
  <properties>
   <property name="Hitpoint" value="2"/>
   <property name="Invulnerable" value="false"/>
   <property name="Name" value="Block2"/>
   <property name="Type" value="Floor"/>
  </properties>
 </tile>
 <tile id="6">
  <properties>
   ...
   <property name="Invulnerable" value="false"/>
   <property name="Name" value="Block1"/>
   <property name="Type" value="Floor"/>
  </properties>
 </tile>
 <tile id="8">
 ...
 <tile id="12">
  <properties>
   <property name="Hitpoint" value="1"/>
   <property name="Invulnerable" value="false"/>
   <property name="Name" value="SpikeTop"/>
