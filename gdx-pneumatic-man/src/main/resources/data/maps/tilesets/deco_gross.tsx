...
<tileset name="deco_gross" tilewidth="128" tileheight="128" spacing="64" margin="64">
 <image source="deco_gross.png" width="640" height="256"/>
 <tile id="0">
  <properties>
 ...
 <tile id="2">
  <properties>
   <property name="Invulnerable" value="true"/>
   <property name="Name" value="Stone3"/>
   <property name="Type" value="Deko"/>
  </properties>
 </tile>
</tileset>
