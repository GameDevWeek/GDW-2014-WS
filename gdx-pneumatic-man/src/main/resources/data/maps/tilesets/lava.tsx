...
<tileset name="lava" tilewidth="64" tileheight="64" spacing="64" margin="64">
 <properties>
  <property name="animationDuration" value="0.5"/>
  <property name="animationFrames" value="4"/>
  <property name="animationOffset" value="1"/>
 </properties>
 <image source="lava.png" width="576" height="320"/>
 <tile id="0">
  <properties>
   <property name="Colour" value="yellowLava"/>
 ...
 <tile id="4">
  <properties>
   ...
   <property name="Light" value="true"/>
   <property name="LightType" value="cone"/>
   <property name="Name" value="Lava5"/>
   <property name="Radius" value="60.0"/>
   <property name="Type" value="Lava"/>
  </properties>
 </tile>
 <tile id="5">
  <properties>
   ...
   <property name="Light" value="true"/>
   <property name="LightType" value="cone"/>
   <property name="Name" value="Lava6"/>
   <property name="Radius" value="60.0"/>
   <property name="Type" value="Lava"/>
  </properties>
 </tile>
 <tile id="6">
  <properties>
   ...
   <property name="Light" value="true"/>
   <property name="LightType" value="cone"/>
   <property name="Name" value="Lava7"/>
   <property name="Radius" value="60.0"/>
   <property name="Type" value="Lava"/>
  </properties>
 </tile>
 <tile id="7">
  <properties>
   ...
   <property name="Light" value="true"/>
   <property name="LightType" value="cone"/>
   <property name="Name" value="Lava8"/>
   <property name="Radius" value="60.0"/>
   <property name="Type" value="Lava"/>
  </properties>
 </tile>
